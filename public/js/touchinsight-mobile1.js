...
function createVisualizationfromQueryList(queryList, duration) {
    ...
    $.ajax({
        ...
        genre_gross.updateMicroViz(dataByGenre, duration);

        genre_budget.updateMicroViz(dataByGenre, duration);

        gross_time.updateMicroViz(dataByTime, duration);

        budget_time.updateMicroViz(dataByTime, duration);
